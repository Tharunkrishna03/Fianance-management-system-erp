...
3. Run Django with `DEBUG=False`, a strong `SECRET_KEY`, explicit `ALLOWED_HOSTS`, explicit `CSRF_TRUSTED_ORIGINS`, and `ENABLE_DEMO_ACCOUNTS=False`.
...
- Demo seed accounts are blocked outside development/test.
